...
const services = [
  {
    ...
    description:
      "Treat your pet to a refreshing grooming experience, including gentle bathing, coat trimming, nail care, and soothing treatments.",
    icon: FaPumpSoap,
  },
  {
    title: "Veterinary Checkups",
    description:
      "Support your pet's long-term health with routine exams, vaccinations, and preventive care.",
    icon: FaBriefcaseMedical,
  },
  {
    title: "Dental Care",
    description:
      "Promote your pet's oral health with thorough cleanings, plaque removal, and fresh breath.",
    icon: FaTooth,
  },
  {
    title: "Nutritional Counseling",
    description:
      "Receive personalized dietary guidance tailored to your pet's needs.",
    icon: FaBowlFood,
  },
  {
    title: "Emergency Care",
    description:
      "Get fast, dependable medical support when urgent health concerns arise.",
    icon: FaBell,
  },
];
...
export function ServicesSection() {
  const { ref, inView } = useInView({
    triggerOnce: true,
    threshold: 0.1, // Triggers early as soon as the top of the section cuts into view
  });
        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          ...
          >
            <div>
              ...
              <p className="mt-3 text-sm leading-6 text-zinc-600">
                Schedule a session with our experienced vets and groomers to
